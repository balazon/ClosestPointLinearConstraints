...
CXX      := g++
CC       := gcc
CXXFLAGS :=  -g -O0 -Wall -std=c++11 -Wno-sign-compare $(Preprocessors)
...
Objects0=$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IntermediateDirectory)/Tester.cpp$(ObjectSuffix) $(IntermediateDirectory)/CPLPSolver.cpp$(ObjectSuffix) $(IntermediateDirectory)/MathUtils.cpp$(ObjectSuffix) 
...
$(IntermediateDirectory)/MathUtils.cpp$(ObjectSuffix): MathUtils.cpp $(IntermediateDirectory)/MathUtils.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/codelitewp/cppwp/ClosestPointLinearConstraints/MathUtils.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/MathUtils.cpp$(ObjectSuffix) $(IncludePath)
